...
public class ActivityMall extends AppCompatActivity
    ...
    public void init() {
        ...
        //layoutManagerLatestPromo = new MeasuredStaggeredGridLayoutManagerViewAll(getApplicationContext(), LinearLayoutManager.VERTICAL, false);
        //mRVpromo.setLayoutManager(layoutManagerLatestPromo);
        //mRVpromo.addItemDecoration(new SpaceItemDecoration(1));


        //mRVpromo.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false));

        /*
        mRVpromo.setItemAnimator(new FadeInAnimator());
        scaleAdapter = new ScaleInAnimationAdapter (adapterTrendingPromo);
